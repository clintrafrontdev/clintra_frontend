...
const roles = ['Freelancer','Student/Intern','Employee','Manager','Executive Team','Owner','Other']

export const RoleSelect: React.FC<RoleSelectProps> = ({ value, onChange, error, pillStyle }) => {
    ...
    return (
      <div className="relative" ref={ref}>
        ...
        >
          ...
          <span className={value ? 'text-gray-700' : 'text-gray-400'}>{value || 'Your role'}</span>
    ...
    <div className="relative" ref={ref}>
      ...
      {isOpen && (
        <div className="absolute z-20 w-full mt-1 bg-gray-800 border border-white/10 rounded-lg shadow-xl">
          {roles.map((r) => (
            <button key={r} type="button" onClick={() => { onChange(r); setIsOpen(false) }}
